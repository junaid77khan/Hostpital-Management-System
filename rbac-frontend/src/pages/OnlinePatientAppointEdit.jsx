...
const OnlinePatientAppointmentEdit = () => {
  ...
  const [appointment, setAppointment] = useState(location.state.patient_details);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const patientData = {
        ...
        blood_pressure_low: formData.blood_pressure_low,
        weight: formData.weight,
        weight_expect: formData.weight_expect,
        height: formData.height,
        height_e: formData.height_e,
        spo2: formData.spo2,
      ...
      // Send patient data to update patient details
      const resp = await fetch(`${process.env.REACT_APP_API_URL}/online_appointments/update_appoint.php`, {
        method: 'POST',
        headers: {
      ...
      if (resp.ok) {
        // If the patient details were updated successfully, update the appointment
        ...
        if (response.ok) {
          ...
          throw new Error(result.error || 'Unknown error occurred while updating appointment.');
        }
      } else {
        throw new Error(result.error || 'Unknown error occurred while updating patient details.');
      }
    } catch (error) {
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-6">
          <h2 className="text-2xl font-semibold mb-4">Edit Online Appointment Details</h2>
...
export default OnlinePatientAppointmentEdit;
