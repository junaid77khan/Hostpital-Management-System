...
const All_Appointments = () => {
    ...
    const fetchAppointments = async () => {
        ...
        try {
            const result = await fetchData({
                API_URL: 'Appointments/GetAllAppointments.php',
                Page_Number: page,
                Limit: limit,
    ...
    const handleSearchChange = (e) => {
        ...
        // Set the new timeout to wait 3 seconds before making the API call
        debounceTimeout.current = setTimeout(() => {
            setDebouncedSearch(value);
        }, 1000); // Wait 3 seconds before making the API call
    };
